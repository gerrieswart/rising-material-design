...
// import { ReactComponent as Logo } from '../images/color_logo_transparent.png';
  ...
  render() {
    return (
      <MDBNavbar color="indigo" dark expand="md">
        <MDBContainer>
          <img src="color_logo_transparent.png" width={100}/>
          <Link to="/" className="navbar-brand">
            <strong className="ml-3 white-text">Rising Sports</strong></Link>
